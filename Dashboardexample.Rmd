...
Player.Names <-
  ...
  filter(Player.Name != "Vadim Demidov") %>%
  filter(Player.Name != "John AlWellness2age") %>%
  filter(Player.Name != "Bashkim Kadrii") %>%
  filter(Player.Name != "Rasmus Schuller") %>%
  filter(Player.Name != "Jeb Brovsky")
