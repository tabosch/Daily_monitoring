...
VB_D_RPE <- DF_wellness[,c("newdate","id", "RPE", "Cog_RPE", "B_RPE", "M_RPE")]
VB_D_RPE$Cog_RPE <- as.numeric(as.character(VB_D_RPE$Cog_RPE))
VB_D_RPE$B_RPE <- as.numeric(as.character(VB_D_RPE$B_RPE))
VB_D_RPE$M_RPE <- as.numeric(as.character(VB_D_RPE$M_RPE))
VB_D_RPE$day <- weekdays(ymd(VB_D_RPE$newdate))
VB_D_RPE$day <- as.factor(VB_D_RPE$day)
VB_D_RPE$day <- factor(VB_D_RPE$day, c("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"))
...
sliderInput("pass2", "Passes", 0, 1000, 100, step = 100)
...
filter_pass <-
  ...
  ggplot(filter_pass, aes(All_Passes, All_PassPct*100, colour=All_diffPct, shape=Club))+geom_point(size=4)+scale_color_gradient2(name="Percent diff \nin passing accuracy", low="red", mid="yellow", high="green", midpoint= 1.0)+geom_text(aes(label=Player), vjust = -1 )+geom_text(aes(label=All_PassPct*100), vjust=2)+theme_dark()+xlab("# of Passes in Attacking Third")+ylab("Expected Passing Percentage in Attacking Third")
})
```
...
filter_pass <-
  ...
  ggplot(filter_pass, aes(ATT_Passes, ATT_xPassPct, colour=ATT_diffPct, shape=Club))+geom_point(size=4)+scale_color_gradient2(name="Percent diff \nin passing accuracy", low="red", mid="yellow", high="green", midpoint= 1.0)+geom_text(aes(label=Player), vjust = -1 )+geom_text(aes(label=ATT_PassPct), vjust=2)+theme_dark()+xlab("# of Passes in Attacking Third")+ylab("Expected Passing Percentage in Attacking Third")
})
```
...
filter_pass_mid <-
  ...
  ggplot(filter_pass_mid, aes(Mid_Passes, Mid_xPassPct, colour=Mid_diffPct, shape=Club))+geom_point(size=4)+scale_color_gradient2(name="Percent diff \nin passing accuracy", low="red", mid="yellow", high="green", midpoint= 1.0)+geom_text(aes(label=Player), vjust = -1 )+geom_text(aes(label=Mid_PassPct), vjust=2)+theme_dark()+xlab("# of Passes in Middle Third")+ylab("Expected Passing Percentage in Middle Third")
})
```
...
filter_pass_def <-
  ...
  ggplot(filter_pass_def, aes(DEF_Passes, DEF_xPassPct, colour=DEF_diffPct, shape=Club))+geom_point(size=4)+scale_color_gradient2(name="Percent diff \nin passing accuracy", low="red", mid="yellow", high="green", midpoint= 0.0)+geom_text(aes(label=Player), vjust = -1 )+geom_text(aes(label=DEF_PassPct), vjust=2)+theme_dark()+xlab("# of Passes in Defensive Third")+ylab("Expected Passing Percentage in Defensive Third")
})
```
...
renderPlot({
 ...
 dist <- ggplot(filter_clubs, aes(All_Distance, fill=Club))+geom_density(stat="density", alpha= 0.5)
 vert <- ggplot(filter_clubs, aes(All_Vertical, fill=Club))+geom_density(stat="density", alpha= 0.5)
 diff <- ggplot(filter_clubs, aes(All_diffPct, fill=Club))+geom_density(stat="density", alpha= 0.5)
 score <- ggplot(filter_clubs, aes(All_Score, fill=Club))+geom_density(stat="density", alpha= 0.5)
