...
```{r, echo=FALSE}
renderUI({
  names <- compliance$Name[compliance$Screened == FALSE]
...
```{r, echo=FALSE}
renderUI({
  names <- DF_wellness_daily$Name[DF_wellness_daily$SQ_S < -1.0 ]
  HTML(paste(names, collapse = "<br />"))
})
```
</div>
...
```{r, echo=FALSE}
renderUI({
  names <- DF_wellness_daily$Name[DF_wellness_daily$SL_S < -1.0 ]
  HTML(paste(names, collapse = "<br />"))
})
```
</div>
...
```{r, echo=FALSE}
renderUI({
  names <- DF_wellness_daily$Name[DF_wellness_daily$RPE_S < -1.0 ]
  HTML(paste(names, collapse = "<br />"))
})
```
</div>
...
```{r, echo=FALSE}
renderUI({
  names <- DF_wellness_daily$Name[DF_wellness_daily$Sore_S < -1.0 ]
  HTML(paste(names, collapse = "<br />"))
})
```
</div>
...
```{r, echo=FALSE}
renderUI({
  names <- DF_wellness_daily$Name[DF_wellness_daily$Stress_S < -1.0 ]
  HTML(paste(names, collapse = "<br />"))
})
```
</div>
